...
echo ===========================================
echo Collection Converter Build Copy Script
echo ===========================================
echo DateTime: !datetime!
echo.

REM Check if .csproj file exists
if not exist "CollectionConverter.csproj" (
    echo ERROR: CollectionConverter.csproj not found!
    echo Make sure you are running this script from the CollectionConverter project directory.
    pause
    exit /b 1
)
...
copy "bin\Debug\net6.0\CollectionConverter.exe" "!debug_folder!\" >nul
copy "bin\Debug\net6.0\CollectionConverter.deps.json" "!debug_folder!\" >nul
copy "bin\Debug\net6.0\CollectionConverter.runtimeconfig.json" "!debug_folder!\" >nul
...
REM Copy required files for execution
copy "bin\Release\net6.0\CollectionConverter.exe" "!release_folder!\" >nul
copy "bin\Release\net6.0\CollectionConverter.deps.json" "!release_folder!\" >nul
copy "bin\Release\net6.0\CollectionConverter.runtimeconfig.json" "!release_folder!\" >nul
...
REM Create output folder
mkdir "!release_folder!\output" >nul
...
echo - Executable file (CollectionConverter.exe)
echo - Runtime configuration files
echo - Dependency libraries (dlls/ folder)
